<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentRefund.ascx.cs" 
Inherits="Collection_UserControls_PaymentRefund" %>
<%@ Register TagPrefix="Custom" Namespace="AlwaysShowHeaderFooter" %>
<%@ Register Src="RefundReceipt.ascx" TagName="RefundReceipt" TagPrefix="uc1" %>
<div runat="server" id="pnlPaymentRefund">
...
<div id="pnlRefundReceipt" runat="server">
    <uc1:RefundReceipt ID="ucRefundReceipt" runat="server" />
</div>
