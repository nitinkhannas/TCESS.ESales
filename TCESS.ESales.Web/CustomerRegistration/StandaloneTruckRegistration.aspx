<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="StandaloneTruckRegistration.aspx.cs" Inherits="Bookings_StandaloneTruckRegistration"
    ValidateRequest="false" %>

<%@ Register Src="UserControls/AddEditStandaloneTrucks.ascx" TagName="AddEditStandaloneTrucks"
    TagPrefix="uc2" %>
<asp:Content ID="PageContent" ContentPlaceHolderID="PageNameContent" runat="Server">
    <asp:Label ID="lblPageName" runat="server" Text="<%$Resources:Labels, AddTransporterTrucks%>"
    ...
    <asp:UpdatePanel runat="server" ID="uplMainPanel" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlAddEditStandaloneTrucks" runat="server">
                <uc2:AddEditStandaloneTrucks ID="ucAddEditStandaloneTrucks" runat="server" />
            </asp:Panel>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
