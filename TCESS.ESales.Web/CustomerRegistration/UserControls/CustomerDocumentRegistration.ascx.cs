...
public partial class CustomerRegistration_UserControls_CustomerDocumentRegistration : BaseUserControl
{
	public event ShowDataEventHandler Event_ShowAddTruckScreen;
	public event ShowDataEventHandler Event_ShowAddAuthRepScreen;
	...
	{
		grdDocument.DataSource = ESalesUnityContainer.Container.Resolve<IDocumentTypeService>().GetDocumentTypeListForCustomers();
	...
	protected void btnAddAuthRep_Click(object sender, EventArgs e)
	{
		...
		Event_ShowAddAuthRepScreen(Convert.ToInt32(ViewState[Globals.StateMgmtVariables.CUSTOMERID]), true, folderName);
	}
