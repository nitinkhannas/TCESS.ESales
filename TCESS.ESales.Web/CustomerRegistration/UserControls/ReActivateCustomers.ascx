<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReActivateCustomers.ascx.cs"
    Inherits="CustomerRegistration_UserControls_ReActivateCustomers" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="<%$Resources:Labels, SNo%>">
                         ...
                         <asp:TemplateField HeaderText="Customer Code">
                            <ItemTemplate>
                                <asp:Label ID="lblFirmName3" runat="server" Text='<%# Bind("Cust_Code") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Date of Site Visit">
                            <ItemTemplate>
                                <asp:Label ID="lblFirmName1" runat="server" Text=' <%#Convert.ToDateTime(Eval("Cust_AMEVisitDate")).ToString("dd-MMM-yyyy")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Date Re- validated">
                            <ItemTemplate>
                                <asp:Label ID="lblFirmName2" runat="server" Text='<%#Convert.ToDateTime(Eval("Cust_AMEReVisitDate")).ToString("dd-MMM-yyyy")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="<%$Resources:Labels, Action%>">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkPrint" runat="server" CommandName="PrintCustomer" CommandArgument='<%# Bind("Cust_ID") %>'
                                    Text="<%$Resources:Labels, Print%>" Font-Underline="False" Visible="False" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
