<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddEditStandaloneTrucks.ascx.cs"
    Inherits="Bookings_UserControls_AddEditStandaloneTrucks" %>
<%@ Register TagPrefix="Custom" Namespace="AlwaysShowHeaderFooter" %>

<table width="100%" cellspacing="5" cellpadding="5">
<tr align="left" >
<td>
 <asp:Label ID="lblTruckcount" runat="server" Text="Day Count" Font-Bold ="true"/>
</td>
<td>
<asp:TextBox ID = "lblTruckcountdata" runat ="server" BorderStyle ="Solid" BorderColor ="Black" CssClass="textbox" ReadOnly ="true" Enabled ="false"></asp:TextBox>
</td>

<td>
 <asp:Label ID="lblTotalTruckcount" runat="server" Text="Truck Regn Count" Font-Bold ="true"/>
</td>
<td>
<asp:TextBox ID = "lblTotalTruckcountdata" runat ="server" BorderStyle ="Solid" BorderColor ="Black" CssClass="textbox" ReadOnly ="true" Enabled ="false"></asp:TextBox>
</td>
</tr>
    <tr align="left">
        <td>
        ...
        <td>
            ...
            <ajax:ValidatorCalloutExtender ID="TruckRegNoCustomValidatorCallout" runat="server"
                TargetControlID="TruckRegNoCustomValidator" />
        </td>
        <td>
        ...
        <td>
            <asp:DropDownList ID="ddlTruckMake" DataTextField="TruckMake_Name" DataValueField="TruckMake_Id"
                runat="server" CssClass="listmenu" AutoPostBack="true" OnSelectedIndexChanged="ddlTruckMake_SelectedIndexChanged" />
    ...
    <tr align="left">
        <td>
            <asp:Label ID="lblOwnerName" runat="server" onkeypress="return runScript(event)" MaxLength="50" Text="<%$Resources:Labels, OwnerName%>" />
        </td>
        <td>
            <asp:TextBox ID="txtOwnerName" onkeypress="return runScript(event)" runat="server"
                CssClass="textbox" Rows="50" />
            <ajax:FilteredTextBoxExtender ID="FilteredtxtOwnerName" runat="server" TargetControlID="txtOwnerName"
        ...
        <td>
            ...
            <ajax:FilteredTextBoxExtender ID="FilteredtxtDriverName" runat="server" TargetControlID="txtDriverName"
                FilterMode="ValidChars" ValidChars=" " FilterType="LowercaseLetters,UppercaseLetters,Custom" />
    ...
    <tr align="left">
        ...
        <td>
            ...
            <ajax:FilteredTextBoxExtender ID="FilteredOwnerShortAddExtender" runat="server" TargetControlID="txtOwnerShortAdd"
                FilterMode="ValidChars" ValidChars=" " FilterType="LowercaseLetters,UppercaseLetters,Custom" />
            <asp:RequiredFieldValidator ID="OwnerShortAddValidator" ControlToValidate="txtOwnerShortAdd"
                ...
                runat="server" />
            <ajax:ValidatorCalloutExtender ID="OwnerShortAddValidatorCallout" runat="server"
        ...
        <td>
            <asp:TextBox ID="txtDriverShortAdd" onkeypress="return runScript(event)" runat="server"
                CssClass="textbox" />
            <ajax:FilteredTextBoxExtender ID="FilteredDriverShortAddExtender" runat="server"
                TargetControlID="txtDriverShortAdd" FilterMode="ValidChars" ValidChars=" " FilterType="LowercaseLetters,UppercaseLetters,Custom" />
            <asp:RequiredFieldValidator ID="DriverShortAddValidator" ControlToValidate="txtDriverShortAdd"
                ...
                runat="server" />
            <ajax:ValidatorCalloutExtender ID="DriverShortAddValidatorCallout" runat="server"
    ...
    <tr align="left">
        ...
        <td>
            ...
            <asp:RegularExpressionValidator ID="MobileNoValidator" runat="server" ControlToValidate="txtMobileNo"
            ...
            <ajax:ValidatorCalloutExtender ID="MobileValidatorCallout" runat="server" TargetControlID="MobileNoValidator" />
        </td>
        <td>
    ...
    <tr>
        <td colspan="4">
            <strong>
                ...
                <asp:HiddenField ID="hdnIfPathExists" runat="server" />
            </strong>
        </td>
    </tr>
</table>
            ...
            <asp:GridView ID="grdDocument" runat="server" AutoGenerateColumns="False" DataKeyNames="Doc_Id"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, Acronym%>">
                        <ItemTemplate>
                            <asp:Label ID="lblAcronym" runat="server" Text='<%# Bind("Doc_Acronym") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, ScanAndSave%>" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnImge" runat="server" />
