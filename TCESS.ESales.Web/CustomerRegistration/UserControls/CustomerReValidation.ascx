<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerReValidation.ascx.cs"
    Inherits="CustomerRegistration_UserControls_CustomerReValidation" %>
<table width="100%" cellspacing="5" cellpadding="5" class="formlabel">
    <tr align="left">
        <td>
            <asp:Label ID="lblCustCode" runat="server" Text="<%$Resources:Labels, CustomerCode%>" />
        </td>
        <td>
            <asp:TextBox ID="txtCustomerCode" runat="server" CssClass="textbox" MaxLength="50" />
            <asp:Button ID="btnValidate" CssClass="button" runat="server" Text="Search" OnClick="btnSave_Click" />
        </td>
        <td>
            &nbsp;
        </td>
        ...
        <td>
            <asp:TextBox ID="txtBankName" runat="server" CssClass="textbox" />
             <asp:RegularExpressionValidator ID="BankNameValidator1" runat="server" ControlToValidate="txtBankName"
                Display="Dynamic" SetFocusOnError="true" Text="*" ValidationGroup="SaveGroup"
                ErrorMessage="Enter Valid Bank Name" CssClass="failureNotification"
    ...
    <tr align="left" runat="server" id="Row3">
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="ChequeNoValidator" ControlToValidate="txtChequeNo" Display="Dynamic"
                ValidationGroup="SaveGroup" SetFocusOnError="true" Text="*" CssClass="failureNotification"
                ErrorMessage="Cheque no cannot be left blank" runat="server" />
    ...
    <tr align="left" runat="server" id="Row8">
        ...
        <td>
            ...
            <ajax:CalendarExtender ID="txtVatFiledOn_CalendarExtender" Format="dd-MMM-yyyy" 
                runat="server" TargetControlID="txtVatFiledOn" />
    ...
    <tr align="left" runat="server" id="Row6">
        <td>
        ...
        <td>
            <asp:Label ID="lblAMEVisitDate2" runat="server" 
    ...
    <tr align="left" runat="server" id="Row5">
        <td>
            &nbsp;
        </td>
        <td style="text-align: right">
            <asp:Button ID="btnCancel" CssClass="button" runat="server" Text="Save" OnClick="btnCancel_Click"
                Visible="False" ValidationGroup="SaveGroup" />
            <asp:Button ID="btnValidateSave" CssClass="button" runat="server" Text="Validate"
                OnClick="btnValidateSave_Click" ValidationGroup="SaveGroup" 
                Visible="False" />
        </td>
        <td>
            <asp:Button ID="btnReset" CssClass="button" runat="server" Text="Edit" 
                OnClick="btnReset_Click" Visible="False" />
            <asp:Button ID="btnClear" CssClass="button" runat="server" Text="Cancel" OnClick="btnClear_Click"
                Visible="False" />
        </td>
        <td>
            &nbsp;
