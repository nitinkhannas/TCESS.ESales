<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerDocumentRegistration.ascx.cs"
    Inherits="CustomerRegistration_UserControls_CustomerDocumentRegistration" %>
<style type="text/css">
    .style1
    {
        height: 38px;
        ...
        <tr>
            <td align="left">
                <asp:Button ID="btnNewRegistration" runat="server" CssClass="button" Text="New Registration"
                    OnClick="btnNewRegistration_Click" />
            </td>
            <td align="center" id="btnCenterArea" runat="server">
                <asp:Button ID="btnAddAuthRep" runat="server" CssClass="button" Text="Add Auth. Representative"
                    OnClick="btnAddAuthRep_Click" />
                <asp:Button ID="btnAddTruck" runat="server" CssClass="button" Text="Add Auth. Trucks"
