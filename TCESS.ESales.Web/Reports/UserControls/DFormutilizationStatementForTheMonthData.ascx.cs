...
public partial class Reports_UserControls_DFormutilizationStatementForTheMonthData : BaseUserControl
{
    int year, month;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        base.ShowBlankRowInGrid<SettlementOfAccountsDTO>(grdDFormutilizationStatementForTheMonth);
    }
    ...
    private void GenerateLoadingAdviceReport(int month, int year)
    {
        ...
        {
            grdDFormutilizationStatementForTheMonth.DataSource = lstSettlementOfAccountsRpt;
            grdDFormutilizationStatementForTheMonth.DataBind();
        }
        else
        {
            base.ShowBlankRowInGrid<SettlementOfAccountsDTO>(grdDFormutilizationStatementForTheMonth);
