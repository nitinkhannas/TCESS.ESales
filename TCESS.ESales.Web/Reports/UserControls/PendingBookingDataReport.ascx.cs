...
public partial class Reports_UserControls_BookingPendingDataReport : BaseUserControl
{
    ...
    public void LoadReport(int agentId,DateTime fromDate, DateTime toDate)
    {
        ...
        IList<BookingDTO> lstPendingBookingRpt = ESalesUnityContainer.Container.Resolve<IReportService>()
            .GetPendingBookingReport(agentId,fromDate, toDate);
        ReportDataSource loadingAdviceDataSource = new ReportDataSource("dsBookingPending", lstPendingBookingRpt);
