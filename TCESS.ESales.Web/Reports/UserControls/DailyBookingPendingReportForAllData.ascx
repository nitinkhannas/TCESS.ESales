<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyBookingPendingReportForAllData.ascx.cs" Inherits="Reports_UserControls_DailyBookingPendingReportForAllData" %>
    ...
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdBooking" runat="server" AutoGenerateColumns="False"
                ...
                AllowPaging="false" HorizontalAlign="Center" Width="100%" 
                CellPadding="5" onpageindexchanging="grdBooking_PageIndexChanging">
                <Columns>
