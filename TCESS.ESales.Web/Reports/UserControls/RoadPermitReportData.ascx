<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RoadPermitReportData.ascx.cs"
    Inherits="Reports_UserControls_RoadPermitReportData" %>
...
<table width="100%">
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdRoadPermit" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Road Permit NO." HeaderStyle-Width="80px">
                        <ItemTemplate>
