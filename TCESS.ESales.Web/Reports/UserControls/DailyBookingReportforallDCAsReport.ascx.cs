...
public partial class Reports_UserControls_DailyBookingReportforallDCAsReport : BaseUserControl
{
    ...
    public void LoadReport(int agentId,DateTime fromDate, DateTime toDate)
    {
        ...
        Common.SetReportEmbeddedResource(reportViewer, "TCESS.ESales.CommonLayer.Reports.DailyBookingReportforallDCAs.rdlc");
        ...
        ReportDataSource loadingAdviceDataSource = new ReportDataSource("dsDailyBookingReportforallDCAs", lstLoadingAdviceRpt);
