<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyBookingReportforCustomerReport.ascx.cs" Inherits="Reports_UserControls_DailyBookingReportforCustomerReport" %>
