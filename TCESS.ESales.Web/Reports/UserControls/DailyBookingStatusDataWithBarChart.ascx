<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyBookingStatusDataWithBarChart.ascx.cs"
    Inherits="Reports_UserControls_DailyBookingStatusDataWithBarChart" %>
...
<asp:UpdatePanel runat="server" ID="TimedPanel" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        ...
        <table width="100%">
                ...
                <td align="center">
                    <Custom:GridViewAlwaysShow ID="grdDailyBookingStatus" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opening Pendings">
                                <ItemTemplate>
                                    <%#Convert.ToInt32(Eval("prevDayBookings"))%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Closing Pendings">
                                <ItemTemplate>
                                    <%#Convert.ToInt32(Eval("pendings"))%>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
            ...
            <tr>
                <td align="center">
                    <asp:Chart ID="Chart1" runat="server" Width="585px">
                        ...
                        <Series>
                            <asp:Series ChartType="Column" ChartArea="ChartArea1">
                                <Points>
                                    <asp:DataPoint AxisLabel="SMS Accepted" XValue="10" Color="Red" />
                                    <asp:DataPoint AxisLabel="Bookings" XValue="30" Color="Orange" />
                                    <asp:DataPoint AxisLabel="Loading Advice Issue" XValue="50" Color="Green" />
                                    <%--<asp:DataPoint AxisLabel="Gate In" XValue="70" Color="Blue" />
                                    <asp:DataPoint AxisLabel="Loaded" XValue="90" Color="DarkSlateGray" />--%>
                                    <asp:DataPoint AxisLabel="Truck Out" XValue="70" Color="Brown" />
                                    <asp:DataPoint AxisLabel="Opening Pendings" XValue="90" Color="DarkTurquoise" />
                                    <asp:DataPoint AxisLabel="Closing Pendings" XValue="110" Color="GreenYellow" />
                                </Points>
                            </asp:Series>
                        </Series>
                        <ChartAreas>
            ...
            <tr>
                <td align="left">
                    <asp:Label ID="lblPageName" runat="server" Text="Booking Allocated" CssClass="pageNameContent"
                        Visible="false" />
                </td>
            </tr>
            <tr>
