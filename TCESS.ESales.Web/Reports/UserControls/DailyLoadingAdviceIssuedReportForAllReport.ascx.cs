...
public partial class Reports_UserControls_DailyLoadingAdviceIssuedReportForAllReport : BaseUserControl
{
    ...
    public void LoadReport(DateTime fromDate, DateTime toDate)
    {
        ...
        Common.SetReportEmbeddedResource(reportViewer, "TCESS.ESales.CommonLayer.Reports.DailyLoadingAdviceIssuedReportForAll.rdlc");
        ...
        IList<BookingDTO> lstLoadingAdviceRpt = ESalesUnityContainer.Container.Resolve<IReportService>()
            .GetDailyLoadingAdviceReportForAll(fromDate, toDate);
        ReportDataSource loadingAdviceDataSource = new ReportDataSource("dsDailyLoadingAdviceIssuedReportForAll", lstLoadingAdviceRpt);
