<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyHandlingIncomeAndServiceTaxStatementReport.ascx.cs" Inherits="Reports_UserControls_DailyHandlingIncomeAndServiceTaxStatementReport" %>
