<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DistrictWiseReportofInactiveCustomersReport.ascx.cs" Inherits="Reports_UserControls_DistrictWiseReportofInactiveCustomersReport" %>
