<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyLoadingAdviceIssuedReportForAllReport.ascx.cs" Inherits="Reports_UserControls_DailyLoadingAdviceIssuedReportForAllReport" %>
