<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyLoadingAdviceIssuedReportForAllData.ascx.cs" Inherits="Reports_DailyLoadingAdviceIssuedReportForAllData" %>
...
<table width="100%">
    <tr>
        <td align="center">
           <Custom:GridViewAlwaysShow ID="grdConsolidatedAdvice" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, TruckNo%>">
                        <ItemTemplate>
                            <%#Eval("Booking_StandaloneTruck_RegNo")%><%#Eval("Booking_Truck_RegNo")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField  HeaderText="<%$Resources:Labels, TSLInvoiceNo%>">
                        <ItemTemplate>
                            <%#Eval("Booking_Account_InvoiceNumber")%>
                        </ItemTemplate>
                        </asp:TemplateField> 
                         <asp:TemplateField HeaderText="<%$Resources:Labels, LoadingAdviceNo%>" >
