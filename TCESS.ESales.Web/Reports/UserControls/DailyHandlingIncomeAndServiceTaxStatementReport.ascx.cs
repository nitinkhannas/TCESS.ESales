...
#endregion
public partial class Reports_UserControls_DailyHandlingIncomeAndServiceTaxStatementReport : BaseUserControl
{
    ...
    public void LoadReport(int agentId, DateTime fromDate, DateTime toDate)
    {
        ...
        Common.SetReportEmbeddedResource(reportViewer, "TCESS.ESales.CommonLayer.Reports.DailyHandlingIncomeAndServiceTaxStatementReport.rdlc");
        ...
        ReportDataSource CashCollectionDataSource = new ReportDataSource("dsDailyHandlingIncomeAndServiceTaxStatementReport", lstDispatchReportRpt);
