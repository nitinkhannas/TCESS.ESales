<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CashCollectionData.ascx.cs"
    Inherits="Reports_UserControls_CashCollectionData" %>
...
<table width="100%">
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdCashcollection" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, BookingNo%>">
                        <ItemTemplate>
                            <%# Eval("MoneyReceipt_AgentShortName")%>-<%# Eval("MoneyReceipt_Booking_Id")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Labels, ReceiptNo%>">
                        <ItemTemplate>
                            MR-<%# Eval("MoneyReceipt_AgentShortName")%>-<%# Eval("MoneyReceipt_Id")%>
                        </ItemTemplate>
                    </asp:TemplateField>                    
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, District%>">
                        <ItemTemplate>
                            <%#Eval("MoneyReceipt_District")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Labels, BookingAdvance%>">
                        <ItemTemplate>
                            <%#Math.Round(Convert.ToDecimal(Eval("MoneyReceipt_BookingAdvance")), 2)%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Labels, AdvanceReceived%>">
                        <ItemTemplate>
                            <%#Math.Round(Convert.ToDecimal(Eval("MoneyReceipt_AmountPaid")), 2)%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Labels, PaymentMode%>">
                        <ItemTemplate>
                            <%# Eval("MoneyReceipt_PaymentMode_PaymentmodeName")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
