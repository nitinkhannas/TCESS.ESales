<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SMSBookingsAcceptedCompletedLapsedData.ascx.cs" Inherits="Reports_UserControls_SMSBookingsAcceptedCompletedLapsedData" %>
...
<table width="100%">
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdSMSBookingsAcceptedCompletedLapsed" runat="server" AutoGenerateColumns="False"
