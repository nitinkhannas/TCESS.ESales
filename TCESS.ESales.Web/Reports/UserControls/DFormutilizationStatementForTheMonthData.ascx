<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DFormutilizationStatementForTheMonthData.ascx.cs" Inherits="Reports_UserControls_DFormutilizationStatementForTheMonthData" %>
...
<table width="100%">
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdDFormutilizationStatementForTheMonth" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Labels, Date%>">
                        <ItemTemplate>
                            <%# Eval("Account_CreatedDate", "{0:d}")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$Resources:Labels, DFormNoIssued%>">
                        <ItemTemplate>
