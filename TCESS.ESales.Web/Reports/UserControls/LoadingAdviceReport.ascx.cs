...
public partial class Reports_UserControls_LoadingAdviceReport : BaseUserControl 
{
    ...
    public void LoadReport(int agentId, DateTime fromDate, DateTime toDate)
    {
        ...
        Common.SetReportEmbeddedResource(reportViewer, "TCESS.ESales.CommonLayer.Reports.DailyLoadingAdviceReport.rdlc");
        ...
        IList<BookingDTO> lstLoadingAdviceRpt = ESalesUnityContainer.Container.Resolve<IReportService>()
            .GetLoadingAdivceReport(agentId, fromDate, toDate);
        ReportDataSource loadingAdviceDataSource = new ReportDataSource("dsLoadingAdviceDetails", lstLoadingAdviceRpt);
