...
public partial class Reports_UserControls_ConsolidatedAdviceReport : BaseUserControl
{
    ...
    public void LoadReport(int agentId, DateTime fromDate, DateTime toDate)
    {
        ...
        Common.SetReportEmbeddedResource(reportViewer, "TCESS.ESales.CommonLayer.Reports.ConsolidatedAdviceReport.rdlc");
        ...
        IList<BookingDTO> lstLoadingAdviceRpt = ESalesUnityContainer.Container.Resolve<IReportService>()
            .GetConsolidatedAdviceReport(agentId, fromDate, toDate);
        ReportDataSource loadingAdviceDataSource = new ReportDataSource("DataSet1", lstLoadingAdviceRpt);
