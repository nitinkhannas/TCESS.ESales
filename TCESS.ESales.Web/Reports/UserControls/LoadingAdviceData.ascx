<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LoadingAdviceData.ascx.cs"
    Inherits="Reports_UserControls_LoadingAdviceData" %>
...
<table width="100%">
    <tr>
        <td align="center">
            <Custom:GridViewAlwaysShow ID="grdLoadingAdvice" runat="server" AutoGenerateColumns="False"
