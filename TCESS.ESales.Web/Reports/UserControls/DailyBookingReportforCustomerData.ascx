<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DailyBookingReportforCustomerData.ascx.cs" Inherits="Reports_UserControls_DailyBookingReportforCustomerData" %>
...
<table width="100%">
    <tr>
        <td align="center">
           <Custom:GridViewAlwaysShow ID="grdDailyBookingReportforCustomer" runat="server" AutoGenerateColumns="False"
