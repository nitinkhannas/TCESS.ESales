...
{
    public partial class ownershipstatu : EntityBase
    {
        #region Primitive Properties
    
        public virtual int OwnershipStatus_Id
        {
            get;
            set;
        }
    
        public virtual string OwnershipStatus_Name
        {
            get;
            set;
        }
    
        public virtual int OwnershipStatus_CreatedBy
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> OwnershipStatus_CreatedDate
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> OwnershipStatus_LastUpdatedDate
        {
            get;
            set;
        }
    
        public virtual bool OwnershipStatus_IsDeleted
        {
            get;
            set;
        }
        ...
        private void Fixupcustomers(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.ownershipstatu, this))
                    {
                        item.ownershipstatu = null;
                    }
                }
            }
        }
