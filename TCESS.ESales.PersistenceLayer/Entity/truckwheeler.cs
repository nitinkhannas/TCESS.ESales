...
{
    public partial class truckwheeler : EntityBase
    {
        #region Primitive Properties
    
        public virtual int TruckWheeler_Id
        {
            get;
            set;
        }
    
        public virtual string TruckWheeler_Value
        {
            get;
            set;
        }
    
        public virtual int TruckWheeler_CreatedBy
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> TruckWheeler_CreatedDate
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> TruckWheeler_LastUpdatedDate
        {
            get;
            set;
        }
    
        public virtual bool TruckWheeler_IsDeleted
        {
            get;
            set;
        }
        ...
        private void Fixuptruckmakes(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.truckwheeler, this))
                    {
                        item.truckwheeler = null;
                    }
                }
            }
        }
